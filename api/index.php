...
const IMG_GEN_REPLACE_MAP = {"islamic geometric pattern background seamless emerald green and gold minimalist&aspect=16:9": "https://lh3.googleusercontent.com/gg/AIJ2gl-dLko3_5JhlJ_KdW3Lyrpbk5uh_HvbBmLXZLxttLoiC2ljf_EcKWMiSCztXeK04DvufRprXUENzqgHR0cOxPJ4Mfrm93p4U-jUojRJttQj1Eg3mNZLCzKz49WZn-ejRsoUYvE_nnZYpDv23yrgeUo0OSqvsBbK6zLjO_u64n-RRBvx6NHGaskv0wVPA2ckRz1c-zn531jsvC-9_-zU3rZRUFIZfpY6Rg1_kew5faLJvAZBL78-geFpKl4T2Onpyl8D3N2kpa4c_HGpirPyXbDQo2hS55M5MCZ-40DuYJaVV3fkfq72PQ8qLARnfirxU2oaHpQLoU9-ZIlM-0fP1n0", "flat illustration silhouette of a person sitting on prayer mat looking at phone peacefully at sunset with mosque dome in background, minimalist vector art, modern style": "https://lh3.googleusercontent.com/gg/AIJ2gl-SHLc9UqWMcVAVj6LuzYv1HZ8_jvDsm8EtEpD2h4O6kG8nqMB9_V7_3o5hbxY3DDmu7Et6kW54hm5pOWf-2Dtmw3qi4H2wgWWU-d8nPvqIraQAdRJsdHJXCC8KOEbTCmokq8oeFQTQBVojO2NpCiKmVVxQeMZMJFsOWLyuEGkJxrCXTSRg8L6oQb0QiGXhC76i-2PrMbICL4hUJY-msydTbc-W9k5me6XYPQlMUcOoA_V_W2e8AQXEpX3gweZMnNhGe_B1zMDICQPI1x4P_rn64XdfRQvsxGm2Ld3NA2qO0vt8zef1htK0-K2O-huz707hPb73CWRf4JOeryLjeIU", "abstract networking connection lines background dark green and black gradient tech style&aspect=16:9": "https://lh3.googleusercontent.com/gg/AIJ2gl8sDySsLptOzeu27TVeouveHVtUvuSgsdafRo_kfPsoiHcot0IhLEvOIL94SaDruCACteORa_5RXKYAkT1NHe_K28e-IFRtI09-200SUQvAU-6lEhd2DeWgbvq4cnfQ27EK-_ncBmYUtJOOq7FAL0XoLw-AoMnYf6p2rScn8anjg2dG-hVMPhir4uj0ROQTirwefu3ozS4YLS5X_kciaFCUIolkJeSeOUn9z8PPGK6_JRzV-fqR87cVM4C4giwVLpCbIF-midVKm7-ZB0sh7fMje0l2GisqIzDh-MGfKjTujaCcfW2zBfmwjQs8UskwIktQtKc4HHtP2jiACSxccXM"};
...
wb);O(IMG_SEARCH_ATTRIBUTION_MAP,Pd);O(IMG_GEN_REPLACE_MAP,fa.A);X();jf();h.A=0})})();document.readyState==="loading"?document.addEventListener("DOMContentLoaded",function(){Zd()}):Zd()})();}).call(this);
    ...
    <title>تطبيق مرآة المؤمن - رفيقك في الطاعة</title>
    
    <!-- Tailwind CSS -->
    <script src="https://cdn.tailwindcss.com"></script>
    
    <!-- Google Fonts: Tajawal for a modern Arabic look -->
...
<style>*, ::before, ::after{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness:proximity;--tw-gradient-from-position: ;--tw-gradient-via-position: ;--tw-gradient-to-position: ;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: ;--tw-contain-size: ;--tw-contain-layout: ;--tw-contain-paint: ;--tw-contain-style: }::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness:proximity;--tw-gradient-from-position: ;--tw-gradient-via-position: ;--tw-gradient-to-position: ;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: ;--tw-contain-size: ;--tw-contain-layout: ;--tw-contain-paint: ;--tw-contain-style: }/* ! tailwindcss v3.4.17 | MIT License | https://tailwindcss.com */*,::after,::before{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}::after,::before{--tw-content:''}:host,html{line-height:1.5;-webkit-text-size-adjust:100%;-moz-tab-size:4;tab-size:4;font-family:ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";font-feature-settings:normal;font-variation-settings:normal;-webkit-tap-highlight-color:transparent}body{margin:0;line-height:inherit}hr{height:0;color:inherit;border-top-width:1px}abbr:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;text-decoration:inherit}b,strong{font-weight:bolder}code,kbd,pre,samp{font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;font-feature-settings:normal;font-variation-settings:normal;font-size:1em}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub{bottom:-.25em}sup{top:-.5em}table{text-indent:0;border-color:inherit;border-collapse:collapse}button,input,optgroup,select,textarea{font-family:inherit;font-feature-settings:inherit;font-variation-settings:inherit;font-size:100%;font-weight:inherit;line-height:inherit;letter-spacing:inherit;color:inherit;margin:0;padding:0}button,select{text-transform:none}button,input:where([type=button]),input:where([type=reset]),input:where([type=submit]){-webkit-appearance:button;background-color:transparent;background-image:none}:-moz-focusring{outline:auto}:-moz-ui-invalid{box-shadow:none}progress{vertical-align:baseline}::-webkit-inner-spin-button,::-webkit-outer-spin-button{height:auto}[type=search]{-webkit-appearance:textfield;outline-offset:-2px}::-webkit-search-decoration{-webkit-appearance:none}::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}summary{display:list-item}blockquote,dd,dl,figure,h1,h2,h3,h4,h5,h6,hr,p,pre{margin:0}fieldset{margin:0;padding:0}legend{padding:0}menu,ol,ul{list-style:none;margin:0;padding:0}dialog{padding:0}textarea{resize:vertical}input::placeholder,textarea::placeholder{opacity:1;color:#9ca3af}[role=button],button{cursor:pointer}:disabled{cursor:default}audio,canvas,embed,iframe,img,object,svg,video{display:block;vertical-align:middle}img,video{max-width:100%;height:auto}[hidden]:where(:not([hidden=until-found])){display:none}.container{width:100%}@media (min-width: 640px){.container{max-width:640px}}@media (min-width: 768px){.container{max-width:768px}}@media (min-width: 1024px){.container{max-width:1024px}}@media (min-width: 1280px){.container{max-width:1280px}}@media (min-width: 1536px){.container{max-width:1536px}}.pointer-events-none{pointer-events:none}.fixed{position:fixed}.absolute{position:absolute}.relative{position:relative}.inset-0{inset:0px}.-bottom-10{bottom:-2.5rem}.-left-10{left:-2.5rem}.-right-10{right:-2.5rem}.top-0{top:0px}.top-10{top:2.5rem}.z-0{z-index:0}.z-10{z-index:10}.z-50{z-index:50}.order-1{order:1}.order-2{order:2}.mx-auto{margin-left:auto;margin-right:auto}.mb-1{margin-bottom:0.25rem}.mb-12{margin-bottom:3rem}.mb-16{margin-bottom:4rem}.mb-2{margin-bottom:0.5rem}.mb-3{margin-bottom:0.75rem}.mb-4{margin-bottom:1rem}.mb-6{margin-bottom:1.5rem}.mb-8{margin-bottom:2rem}.mt-4{margin-top:1rem}.mt-6{margin-top:1.5rem}.mt-2{margin-top:0.5rem}.inline-block{display:inline-block}.flex{display:flex}.grid{display:grid}.h-10{height:2.5rem}.h-24{height:6rem}.h-3{height:0.75rem}.h-32{height:8rem}.h-\[500px\]{height:500px}.h-full{height:100%}.min-h-screen{min-height:100vh}.w-10{width:2.5rem}.w-24{width:6rem}.w-32{width:8rem}.w-80{width:20rem}.w-full{width:100%}.max-w-2xl{max-width:42rem}.max-w-3xl{max-width:48rem}.max-w-4xl{max-width:56rem}.max-w-md{max-width:28rem}.flex-1{flex:1 1 0%}.rotate-1{--tw-rotate:1deg;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.transform{transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.cursor-pointer{cursor:pointer}.flex-col{flex-direction:column}.flex-wrap{flex-wrap:wrap}.items-center{align-items:center}.justify-end{justify-content:flex-end}.justify-center{justify-content:center}.justify-between{justify-content:space-between}.gap-1{gap:0.25rem}.gap-12{gap:3rem}.gap-16{gap:4rem}.gap-2{gap:0.5rem}.gap-3{gap:0.75rem}.gap-4{gap:1rem}.gap-6{gap:1.5rem}.gap-8{gap:2rem}.space-y-2 > :not([hidden]) ~ :not([hidden]){--tw-space-y-reverse:0;margin-top:calc(0.5rem * calc(1 - var(--tw-space-y-reverse)));margin-bottom:calc(0.5rem * var(--tw-space-y-reverse))}.space-y-4 > :not([hidden]) ~ :not([hidden]){--tw-space-y-reverse:0;margin-top:calc(1rem * calc(1 - var(--tw-space-y-reverse)));margin-bottom:calc(1rem * var(--tw-space-y-reverse))}.overflow-hidden{overflow:hidden}.overflow-y-auto{overflow-y:auto}.rounded{border-radius:0.25rem}.rounded-2xl{border-radius:1rem}.rounded-3xl{border-radius:1.5rem}.rounded-full{border-radius:9999px}.rounded-lg{border-radius:0.5rem}.rounded-xl{border-radius:0.75rem}.border{border-width:1px}.border-2{border-width:2px}.border-b{border-bottom-width:1px}.border-r-4{border-right-width:4px}.border-t{border-top-width:1px}.border-none{border-style:none}.border-blue-100{--tw-border-opacity:1;border-color:rgb(219 234 254 / var(--tw-border-opacity, 1))}.border-emerald-100{--tw-border-opacity:1;border-color:rgb(209 250 229 / var(--tw-border-opacity, 1))}.border-emerald-500{--tw-border-opacity:1;border-color:rgb(16 185 129 / var(--tw-border-opacity, 1))}.border-emerald-600{--tw-border-opacity:1;border-color:rgb(5 150 105 / var(--tw-border-opacity, 1))}.border-gray-100{--tw-border-opacity:1;border-color:rgb(243 244 246 / var(--tw-border-opacity, 1))}.border-gray-200{--tw-border-opacity:1;border-color:rgb(229 231 235 / var(--tw-border-opacity, 1))}.border-gray-300{--tw-border-opacity:1;border-color:rgb(209 213 219 / var(--tw-border-opacity, 1))}.border-gray-800{--tw-border-opacity:1;border-color:rgb(31 41 55 / var(--tw-border-opacity, 1))}.border-purple-100{--tw-border-opacity:1;border-color:rgb(243 232 255 / var(--tw-border-opacity, 1))}.border-red-500\/50{border-color:rgb(239 68 68 / 0.5)}.border-yellow-400{--tw-border-opacity:1;border-color:rgb(250 204 21 / var(--tw-border-opacity, 1))}.bg-black{--tw-bg-opacity:1;background-color:rgb(0 0 0 / var(--tw-bg-opacity, 1))}.bg-blue-50{--tw-bg-opacity:1;background-color:rgb(239 246 255 / var(--tw-bg-opacity, 1))}.bg-blue-600{--tw-bg-opacity:1;background-color:rgb(37 99 235 / var(--tw-bg-opacity, 1))}.bg-emerald-100{--tw-bg-opacity:1;background-color:rgb(209 250 229 / var(--tw-bg-opacity, 1))}.bg-emerald-400{--tw-bg-opacity:1;background-color:rgb(52 211 153 / var(--tw-bg-opacity, 1))}.bg-emerald-50{--tw-bg-opacity:1;background-color:rgb(236 253 245 / var(--tw-bg-opacity, 1))}.bg-emerald-500{--tw-bg-opacity:1;background-color:rgb(16 185 129 / var(--tw-bg-opacity, 1))}.bg-emerald-600{--tw-bg-opacity:1;background-color:rgb(5 150 105 / var(--tw-bg-opacity, 1))}.bg-gray-100{--tw-bg-opacity:1;background-color:rgb(243 244 246 / var(--tw-bg-opacity, 1))}.bg-gray-400{--tw-bg-opacity:1;background-color:rgb(156 163 175 / var(--tw-bg-opacity, 1))}.bg-gray-50{--tw-bg-opacity:1;background-color:rgb(249 250 251 / var(--tw-bg-opacity, 1))}.bg-gray-900{--tw-bg-opacity:1;background-color:rgb(17 24 39 / var(--tw-bg-opacity, 1))}.bg-orange-400{--tw-bg-opacity:1;background-color:rgb(251 146 60 / var(--tw-bg-opacity, 1))}.bg-purple-50{--tw-bg-opacity:1;background-color:rgb(250 245 255 / var(--tw-bg-opacity, 1))}.bg-red-400{--tw-bg-opacity:1;background-color:rgb(248 113 113 / var(--tw-bg-opacity, 1))}.bg-red-500\/20{background-color:rgb(239 68 68 / 0.2)}.bg-white{--tw-bg-opacity:1;background-color:rgb(255 255 255 / var(--tw-bg-opacity, 1))}.bg-white\/90{background-color:rgb(255 255 255 / 0.9)}.bg-yellow-400{--tw-bg-opacity:1;background-color:rgb(250 204 21 / var(--tw-bg-opacity, 1))}.bg-gray-200{--tw-bg-opacity:1;background-color:rgb(229 231 235 / var(--tw-bg-opacity, 1))}.bg-gradient-to-b{background-image:linear-gradient(to bottom, var(--tw-gradient-stops))}.from-emerald-600{--tw-gradient-from:#059669 var(--tw-gradient-from-position);--tw-gradient-to:rgb(5 150 105 / 0) var(--tw-gradient-to-position);--tw-gradient-stops:var(--tw-gradient-from), var(--tw-gradient-to)}.to-teal-800{--tw-gradient-to:#115e59 var(--tw-gradient-to-position)}.object-cover{object-fit:cover}.p-3{padding:0.75rem}.p-4{padding:1rem}.p-6{padding:1.5rem}.p-8{padding:2rem}.px-3{padding-left:0.75rem;padding-right:0.75rem}.px-4{padding-left:1rem;padding-right:1rem}.px-5{padding-left:1.25rem;padding-right:1.25rem}.px-6{padding-left:1.5rem;padding-right:1.5rem}.px-8{padding-left:2rem;padding-right:2rem}.py-1{padding-top:0.25rem;padding-bottom:0.25rem}.py-2{padding-top:0.5rem;padding-bottom:0.5rem}.py-20{padding-top:5rem;padding-bottom:5rem}.py-24{padding-top:6rem;padding-bottom:6rem}.py-3{padding-top:0.75rem;padding-bottom:0.75rem}.py-4{padding-top:1rem;padding-bottom:1rem}.py-8{padding-top:2rem;padding-bottom:2rem}.px-2{padding-left:0.5rem;padding-right:0.5rem}.pb-20{padding-bottom:5rem}.pb-4{padding-bottom:1rem}.pr-4{padding-right:1rem}.pt-32{padding-top:8rem}.pt-6{padding-top:1.5rem}.pt-2{padding-top:0.5rem}.text-center{text-align:center}.text-right{text-align:right}.text-2xl{font-size:1.5rem;line-height:2rem}.text-3xl{font-size:1.875rem;line-height:2.25rem}.text-4xl{font-size:2.25rem;line-height:2.5rem}.text-5xl{font-size:3rem;line-height:1}.text-lg{font-size:1.125rem;line-height:1.75rem}.text-sm{font-size:0.875rem;line-height:1.25rem}.text-xl{font-size:1.25rem;line-height:1.75rem}.text-xs{font-size:0.75rem;line-height:1rem}.font-black{font-weight:900}.font-bold{font-weight:700}.uppercase{text-transform:uppercase}.italic{font-style:italic}.leading-loose{line-height:2}.leading-relaxed{line-height:1.625}.leading-tight{line-height:1.25}.text-black{--tw-text-opacity:1;color:rgb(0 0 0 / var(--tw-text-opacity, 1))}.text-blue-800{--tw-text-opacity:1;color:rgb(30 64 175 / var(--tw-text-opacity, 1))}.text-emerald-400{--tw-text-opacity:1;color:rgb(52 211 153 / var(--tw-text-opacity, 1))}.text-emerald-500{--tw-text-opacity:1;color:rgb(16 185 129 / var(--tw-text-opacity, 1))}.text-emerald-600{--tw-text-opacity:1;color:rgb(5 150 105 / var(--tw-text-opacity, 1))}.text-emerald-700{--tw-text-opacity:1;color:rgb(4 120 87 / var(--tw-text-opacity, 1))}.text-emerald-800{--tw-text-opacity:1;color:rgb(6 95 70 / var(--tw-text-opacity, 1))}.text-gray-300{--tw-text-opacity:1;color:rgb(209 213 219 / var(--tw-text-opacity, 1))}.text-gray-400{--tw-text-opacity:1;color:rgb(156 163 175 / var(--tw-text-opacity, 1))}.text-gray-500{--tw-text-opacity:1;color:rgb(107 114 128 / var(--tw-text-opacity, 1))}.text-gray-600{--tw-text-opacity:1;color:rgb(75 85 99 / var(--tw-text-opacity, 1))}.text-gray-700{--tw-text-opacity:1;color:rgb(55 65 81 / var(--tw-text-opacity, 1))}.text-gray-800{--tw-text-opacity:1;color:rgb(31 41 55 / var(--tw-text-opacity, 1))}.text-gray-900{--tw-text-opacity:1;color:rgb(17 24 39 / var(--tw-text-opacity, 1))}.text-green-600{--tw-text-opacity:1;color:rgb(22 163 74 / var(--tw-text-opacity, 1))}.text-orange-500{--tw-text-opacity:1;color:rgb(249 115 22 / var(--tw-text-opacity, 1))}.text-purple-600{--tw-text-opacity:1;color:rgb(147 51 234 / var(--tw-text-opacity, 1))}.text-purple-700{--tw-text-opacity:1;color:rgb(126 34 206 / var(--tw-text-opacity, 1))}.text-purple-800{--tw-text-opacity:1;color:rgb(107 33 168 / var(--tw-text-opacity, 1))}.text-red-300{--tw-text-opacity:1;color:rgb(252 165 165 / var(--tw-text-opacity, 1))}.text-red-500{--tw-text-opacity:1;color:rgb(239 68 68 / var(--tw-text-opacity, 1))}.text-white{--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity, 1))}.text-yellow-400{--tw-text-opacity:1;color:rgb(250 204 21 / var(--tw-text-opacity, 1))}.opacity-20{opacity:0.2}.opacity-50{opacity:0.5}.opacity-60{opacity:0.6}.opacity-75{opacity:0.75}.opacity-90{opacity:0.9}.shadow-2xl{--tw-shadow:0 25px 50px -12px rgb(0 0 0 / 0.25);--tw-shadow-colored:0 25px 50px -12px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}.shadow-lg{--tw-shadow:0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 10px 15px -3px var(--tw-shadow-color), 0 4px 6px -4px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}.shadow-sm{--tw-shadow:0 1px 2px 0 rgb(0 0 0 / 0.05);--tw-shadow-colored:0 1px 2px 0 var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}.shadow-xl{--tw-shadow:0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 20px 25px -5px var(--tw-shadow-color), 0 8px 10px -6px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}.blur-2xl{--tw-blur:blur(40px);filter:var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)}.backdrop-blur-md{--tw-backdrop-blur:blur(12px);-webkit-backdrop-filter:var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia);backdrop-filter:var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)}.transition{transition-property:color, background-color, border-color, fill, stroke, opacity, box-shadow, transform, filter, -webkit-text-decoration-color, -webkit-backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, opacity, box-shadow, transform, filter, backdrop-filter, -webkit-text-decoration-color, -webkit-backdrop-filter;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms}.transition-all{transition-property:all;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms}.delay-100{transition-delay:100ms}.duration-500{transition-duration:500ms}.duration-300{transition-duration:300ms}.hover\:-translate-y-1:hover{--tw-translate-y:-0.25rem;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.hover\:rotate-0:hover{--tw-rotate:0deg;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.hover\:scale-105:hover{--tw-scale-x:1.05;--tw-scale-y:1.05;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.hover\:border-gray-300:hover{--tw-border-opacity:1;border-color:rgb(209 213 219 / var(--tw-border-opacity, 1))}.hover\:bg-emerald-100:hover{--tw-bg-opacity:1;background-color:rgb(209 250 229 / var(--tw-bg-opacity, 1))}.hover\:bg-emerald-50:hover{--tw-bg-opacity:1;background-color:rgb(236 253 245 / var(--tw-bg-opacity, 1))}.hover\:bg-emerald-700:hover{--tw-bg-opacity:1;background-color:rgb(4 120 87 / var(--tw-bg-opacity, 1))}.hover\:bg-gray-100:hover{--tw-bg-opacity:1;background-color:rgb(243 244 246 / var(--tw-bg-opacity, 1))}.hover\:bg-gray-50:hover{--tw-bg-opacity:1;background-color:rgb(249 250 251 / var(--tw-bg-opacity, 1))}.hover\:bg-gray-900:hover{--tw-bg-opacity:1;background-color:rgb(17 24 39 / var(--tw-bg-opacity, 1))}.hover\:bg-emerald-200:hover{--tw-bg-opacity:1;background-color:rgb(167 243 208 / var(--tw-bg-opacity, 1))}.hover\:bg-orange-200:hover{--tw-bg-opacity:1;background-color:rgb(254 215 170 / var(--tw-bg-opacity, 1))}.hover\:bg-red-200:hover{--tw-bg-opacity:1;background-color:rgb(254 202 202 / var(--tw-bg-opacity, 1))}.hover\:underline:hover{-webkit-text-decoration-line:underline;text-decoration-line:underline}.focus\:outline-none:focus{outline:2px solid transparent;outline-offset:2px}.focus\:ring-0:focus{--tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);--tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(0px + var(--tw-ring-offset-width)) var(--tw-ring-color);box-shadow:var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow, 0 0 #0000)}.focus\:ring-2:focus{--tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);--tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);box-shadow:var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow, 0 0 #0000)}.focus\:ring-emerald-500:focus{--tw-ring-opacity:1;--tw-ring-color:rgb(16 185 129 / var(--tw-ring-opacity, 1))}@media (min-width: 640px){.sm\:flex-row{flex-direction:row}}@media (min-width: 768px){.md\:order-1{order:1}.md\:order-2{order:2}.md\:grid-cols-2{grid-template-columns:repeat(2, minmax(0, 1fr))}.md\:justify-start{justify-content:flex-start}.md\:text-right{text-align:right}.md\:text-4xl{font-size:2.25rem;line-height:2.5rem}.md\:text-5xl{font-size:3rem;line-height:1}.md\:text-6xl{font-size:3.75rem;line-height:1}}</style><link type="text/css" href="https://fonts.googleapis.com/css2?family=Google+Symbols:opsz,wght,FILL,GRAD,ROND@24,400,0,0,50&amp;icon_names=link" rel="stylesheet"><style id="dyn-img-link-styles-di-script">
      .dyn-img-link-wrapper-di-script {
        anchor-scope: all;
        display: contents;
        position: relative;
...
<body class="text-gray-800">
    ...
    <nav class="fixed top-0 w-full bg-white/90 backdrop-blur-md shadow-sm z-50">
        <div class="container mx-auto px-6 py-3 flex justify-between items-center">
            <div class="flex items-center gap-2">
                <span class="material-symbols-outlined text-emerald-600 text-3xl">mosque</span>
                <span class="text-xl font-bold text-emerald-800">مرآة المؤمن</span>
            </div>
            <button 
                onclick="window.location.href='../app.apk'"
                class="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2 rounded-full font-bold transition shadow-lg">
                حمل التطبيق
            </button>
        </div>
    </nav>
    ...
    <!-- Hero Section -->
    <section class="relative pt-32 pb-20 px-6 min-h-screen flex items-center justify-center overflow-hidden">
        <div class="absolute inset-0 z-0 opacity-20">
             <img style="" src="blob:https://0o1lg8888rda2x71d4cer4y7mdnkuqd9mbgkcb4u0yrvk8ainz-h839267052.scf.usercontent.goog/51ba4b92-7893-4843-8d1d-6d2a5e0e2ff6" go-data-src="/gen?prompt=islamic+geometric+pattern+background+seamless+emerald+green+and+gold+minimalist&amp;aspect=16:9" alt="Background Pattern" class="w-full h-full object-cover">
        </div>
        
        <div class="container mx-auto z-10 grid md:grid-cols-2 gap-12 items-center">
            <div class="text-center md:text-right fade-in">
                <span class="inline-block py-1 px-3 rounded-full bg-emerald-100 text-emerald-700 text-sm font-bold mb-4">تطبيقك الإسلامي المتكامل</span>
                <h1 class="text-4xl md:text-6xl font-black text-gray-900 leading-tight mb-6">
                    عمرك حسيت إن يومك بيعدّي...<br>
                    <span class="text-emerald-600">وفجأة تكتشف إنك ضيّعت صلوات؟</span>
                </h1>
                <p class="text-xl text-gray-600 mb-8 leading-relaxed">
                    نفسك تلتزم أكتر بس مفيش اللي يشجعك؟ <br>
                    <strong>مرآة المؤمن</strong> معمول مخصوص عشانك.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <button onclick="document.getElementById('features').scrollIntoView()" class="bg-emerald-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-emerald-700 transition shadow-lg flex items-center justify-center gap-2">
                        <span class="material-symbols-outlined">play_circle</span>
                        شاهد المميزات
                    </button>
                    <button onclick="window.location.href='../app.apk'" class="bg-white text-emerald-600 border-2 border-emerald-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-emerald-50 transition flex items-center justify-center gap-2">
            ...
            <div class="relative fade-in delay-100 flex justify-center">
                <div class="relative w-full max-w-md">
                    <!-- Illustration -->
                     <img src="../assets/image/Screenshot 2025-12-05 023141.png" go-data-src="/gen?prompt=flat+illustration+silhouette+of+a+person+sitting+on+prayer+mat+looking+at+phone+peacefully+at+sunset+with+mosque+dome+in+background,+minimalist+vector+art,+modern+style&amp;aspect=1:1" alt="Peaceful Prayer" class="rounded-3xl shadow-2xl relative z-10 hover:scale-105 transition duration-500" style="">
                     <!-- Decorative blobs -->
                     <div class="absolute top-10 -right-10 w-24 h-24 bg-yellow-400 rounded-full blur-2xl opacity-50"></div>
                     <div class="absolute -bottom-10 -left-10 w-32 h-32 bg-emerald-400 rounded-full blur-2xl opacity-50"></div>
                </div>
            </div>
        </div>
    </section>

    <!-- Feature 1: Prayer Tracking -->
        ...
        <div class="container mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div class="order-2 md:order-1 flex justify-center">
                    <div class="phone-mockup w-80 h-[500px] bg-gray-50 flex flex-col">
                        <div class="phone-notch"></div>
                        <!-- App Header -->
                        <div class="bg-emerald-600 h-24 p-4 flex flex-col justify-end text-white">
                            <h3 class="font-bold">صلواتي اليوم</h3>
                            <p class="text-xs opacity-90">الجمعة، ٥ ديسمبر</p>
                        </div>
                        <!-- App Content -->
                        <div class="flex-1 p-4 overflow-y-auto" id="prayer-list-container"><div class="mb-3 p-3 rounded-lg border-2 transition-all duration-300 bg-white border-gray-100 hover:border-gray-300">
                    <div class="flex justify-between items-center mb-2">
                        <span class="font-bold text-lg">الفجر</span>
                        <span class="material-symbols-outlined cursor-pointer" onclick="toggleStatus(0)">radio_button_unchecked</span>
                    </div>
                    
                    <div class="flex gap-2 text-xs">
                        <button onclick="setStatus(0, 'done')" class="px-2 py-1 rounded bg-gray-200 hover:bg-emerald-200">صليت</button>
                        <button onclick="setStatus(0, 'late')" class="px-2 py-1 rounded bg-gray-200 hover:bg-orange-200">قضاء</button>
                        <button onclick="setStatus(0, 'missed')" class="px-2 py-1 rounded bg-gray-200 hover:bg-red-200">فاتتني</button>
                    </div>

                    <div class="mt-2 pt-2 border-t border-gray-100 flex items-center gap-2 cursor-pointer" onclick="toggleSunnah(0)">
                        <span class="material-symbols-outlined text-sm text-gray-300">star_outline</span>
                        <span class="text-sm ">السنة / النافلة</span>
                    </div>
                </div><div class="mb-3 p-3 rounded-lg border-2 transition-all duration-300 bg-white border-gray-100 hover:border-gray-300">
                    <div class="flex justify-between items-center mb-2">
                        <span class="font-bold text-lg">الظهر</span>
                        <span class="material-symbols-outlined cursor-pointer" onclick="toggleStatus(1)">radio_button_unchecked</span>
                    </div>
                    
                    <div class="flex gap-2 text-xs">
                        <button onclick="setStatus(1, 'done')" class="px-2 py-1 rounded bg-gray-200 hover:bg-emerald-200">صليت</button>
                        <button onclick="setStatus(1, 'late')" class="px-2 py-1 rounded bg-gray-200 hover:bg-orange-200">قضاء</button>
                        <button onclick="setStatus(1, 'missed')" class="px-2 py-1 rounded bg-gray-200 hover:bg-red-200">فاتتني</button>
                    </div>

                    <div class="mt-2 pt-2 border-t border-gray-100 flex items-center gap-2 cursor-pointer" onclick="toggleSunnah(1)">
                        <span class="material-symbols-outlined text-sm text-gray-300">star_outline</span>
                        <span class="text-sm ">السنة / النافلة</span>
                    </div>
                </div><div class="mb-3 p-3 rounded-lg border-2 transition-all duration-300 bg-white border-gray-100 hover:border-gray-300">
                    <div class="flex justify-between items-center mb-2">
                        <span class="font-bold text-lg">العصر</span>
                        <span class="material-symbols-outlined cursor-pointer" onclick="toggleStatus(2)">radio_button_unchecked</span>
                    </div>
                    
                    <div class="flex gap-2 text-xs">
                        <button onclick="setStatus(2, 'done')" class="px-2 py-1 rounded bg-gray-200 hover:bg-emerald-200">صليت</button>
                        <button onclick="setStatus(2, 'late')" class="px-2 py-1 rounded bg-gray-200 hover:bg-orange-200">قضاء</button>
                        <button onclick="setStatus(2, 'missed')" class="px-2 py-1 rounded bg-gray-200 hover:bg-red-200">فاتتني</button>
                    </div>

                    <div class="mt-2 pt-2 border-t border-gray-100 flex items-center gap-2 cursor-pointer" onclick="toggleSunnah(2)">
                        <span class="material-symbols-outlined text-sm text-gray-300">star_outline</span>
                        <span class="text-sm ">السنة / النافلة</span>
                    </div>
                </div><div class="mb-3 p-3 rounded-lg border-2 transition-all duration-300 bg-white border-gray-100 hover:border-gray-300">
                    <div class="flex justify-between items-center mb-2">
                        <span class="font-bold text-lg">المغرب</span>
                        <span class="material-symbols-outlined cursor-pointer" onclick="toggleStatus(3)">radio_button_unchecked</span>
                    </div>
                    
                    <div class="flex gap-2 text-xs">
                        <button onclick="setStatus(3, 'done')" class="px-2 py-1 rounded bg-gray-200 hover:bg-emerald-200">صليت</button>
                        <button onclick="setStatus(3, 'late')" class="px-2 py-1 rounded bg-gray-200 hover:bg-orange-200">قضاء</button>
                        <button onclick="setStatus(3, 'missed')" class="px-2 py-1 rounded bg-gray-200 hover:bg-red-200">فاتتني</button>
                    </div>

                    <div class="mt-2 pt-2 border-t border-gray-100 flex items-center gap-2 cursor-pointer" onclick="toggleSunnah(3)">
                        <span class="material-symbols-outlined text-sm text-gray-300">star_outline</span>
                        <span class="text-sm ">السنة / النافلة</span>
                    </div>
                </div><div class="mb-3 p-3 rounded-lg border-2 transition-all duration-300 bg-white border-gray-100 hover:border-gray-300">
                    <div class="flex justify-between items-center mb-2">
                        <span class="font-bold text-lg">العشاء</span>
                        <span class="material-symbols-outlined cursor-pointer" onclick="toggleStatus(4)">radio_button_unchecked</span>
                    </div>
                    
                    <div class="flex gap-2 text-xs">
                        <button onclick="setStatus(4, 'done')" class="px-2 py-1 rounded bg-gray-200 hover:bg-emerald-200">صليت</button>
                        <button onclick="setStatus(4, 'late')" class="px-2 py-1 rounded bg-gray-200 hover:bg-orange-200">قضاء</button>
                        <button onclick="setStatus(4, 'missed')" class="px-2 py-1 rounded bg-gray-200 hover:bg-red-200">فاتتني</button>
                    </div>

                    <div class="mt-2 pt-2 border-t border-gray-100 flex items-center gap-2 cursor-pointer" onclick="toggleSunnah(4)">
                        <span class="material-symbols-outlined text-sm text-gray-300">star_outline</span>
                        <span class="text-sm ">السنة / النافلة</span>
                    </div>
                </div></div>
                ...
                <div class="order-1 md:order-2">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h2 class="text-3xl font-bold text-gray-900">أول ميزة... تتبّع الصلوات</h2>
                    </div>
                    <p class="text-xl text-gray-600 leading-loose mb-6">
                        "التطبيق بيعرضلك الفروض اليومية، وكل صلاة بتختار حالتها: <span class="font-bold text-emerald-600">صلّيتها؟</span> <span class="font-bold text-orange-500">متأخرة؟</span> ولا <span class="font-bold text-red-500">لسه؟</span>"
                    </p>
                    <p class="text-lg text-gray-500 mb-8 border-r-4 border-yellow-400 pr-4 italic">
                        "ومع كل فرض، تقدر تختار النوافل اللي بتحب تحافظ عليها."
                    </p>
                    
                    <div class="bg-blue-50 p-4 rounded-lg border border-blue-100">
                        <p class="text-sm text-blue-800 flex items-center gap-2">
                            <span class="material-symbols-outlined">touch_app</span>
                            <strong>جرب بنفسك:</strong> اضغط على الصلوات في الهاتف لتغيير حالتها!
                        </p>
                    </div>
                </div>
    ...
    <!-- Feature 2: Custom Habits -->
    <section class="py-20 bg-emerald-50">
        <div class="container mx-auto px-6">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="material-symbols-outlined text-emerald-500 text-5xl mb-4">edit_note</span>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">مش بس صلوات!</h2>
                <p class="text-xl text-gray-700 leading-relaxed">
                    "تقدر تضيف أي عبادة انت عايزها بنفسك: قيام الليل، قراءة صفحة قرآن، أذكار... أي حاجة تقدر تدخلها وتتابعها."
                </p>
            </div>

            <!-- Interactive Habit Builder -->
            <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden p-8">
                <div class="grid md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <div class="flex gap-2 mb-4">
                            <input type="text" id="habit-input" placeholder="مثلاً: قراءة سورة الملك" class="flex-1 border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-emerald-500">
                            <button onclick="addHabit()" class="bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition">إضافة</button>
                        </div>
                        <div class="flex flex-wrap gap-2 mb-6">
                            <button onclick="fillHabit('قيام الليل')" class="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-sm hover:bg-emerald-100 transition">قيام الليل</button>
                            <button onclick="fillHabit('الورد اليومي')" class="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-sm hover:bg-emerald-100 transition">الورد اليومي</button>
                            <button onclick="fillHabit('صدقة')" class="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-sm hover:bg-emerald-100 transition">صدقة</button>
                        </div>
                        <p class="text-sm text-gray-400">أي عبادة تضيفها ستظهر في جدولك اليومي.</p>
                    </div>
                    
                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                        <h4 class="font-bold text-gray-700 mb-3 text-center">جدول العبادات الإضافية</h4>
                        <ul id="habit-list" class="space-y-2">
                            <li class="flex items-center justify-between bg-white p-3 rounded shadow-sm border-r-4 border-emerald-500">
                                <span>أذكار الصباح</span>
                                <span class="material-symbols-outlined text-emerald-500">check_circle</span>
                            </li>
                            <li class="flex items-center justify-between bg-white p-3 rounded shadow-sm border-r-4 border-gray-200">
        ...
        <div class="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="order-1">
                 <h2 class="text-3xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <span class="material-symbols-outlined text-purple-600 text-4xl">monitoring</span>
                    والجامد بقى... الإحصائيات
                 </h2>
                 <p class="text-xl text-gray-600 mb-6">
                    "هتشوف كل حاجة بالتفصيل الممل: أداؤك الأسبوعي، معدل التزامك، أوقات التقصير... وكل ده بشكل بسيط وواضح."
                 </p>
                 <div class="bg-purple-50 p-6 rounded-2xl border border-purple-100">
                    <h4 class="font-bold text-purple-800 mb-2">لماذا الإحصائيات؟</h4>
                    <p class="text-purple-700">عشان تعرف نقاط ضعفك وتعالجها. لو لقيت صلاة الفجر دايمًا حمراء (فائتة)، التطبيق هينبهك ويقترح حلول!</p>
                 </div>
            </div>

            <!-- Visual Stats -->
            <div class="order-2 bg-white rounded-3xl shadow-2xl p-6 border border-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="font-bold text-gray-700">تقرير الأسبوع</h3>
                    <select class="bg-gray-100 rounded-lg px-3 py-1 text-sm border-none focus:ring-0">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <div class="flex justify-between text-sm text-gray-500 mb-1">
                            <span>الظهر</span>
                            <span class="text-emerald-600 font-bold">90%</span>
                        </div>
                        <div class="h-3 bg-gray-100 rounded-full overflow-hidden">
                    ...
                    <div>
                     ...
                     <div>
                        ...
                        <div class="h-3 bg-gray-100 rounded-full overflow-hidden">
                            <div class="h-full bg-red-400 rounded-full" style="width: 40%"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 pt-6 border-t flex justify-between">
                    <div class="text-center">
                        <p class="text-xs text-gray-400">إجمالي الالتزام</p>
                        <p class="text-2xl font-black text-gray-800">78%</p>
                    </div>
                    <div class="text-center">
                        <p class="text-xs text-gray-400">النوافل</p>
                        <p class="text-2xl font-black text-emerald-600">12</p>
                    </div>
                    <div class="text-center">
                        <p class="text-xs text-gray-400">أيام متصلة</p>
    ...
    <!-- The Dialogue & USP (Mudaawama) -->
    <section class="py-24 bg-gray-900 text-white relative overflow-hidden">
        <!-- Background Image -->
         <img src="blob:https://0o1lg8888rda2x71d4cer4y7mdnkuqd9mbgkcb4u0yrvk8ainz-h839267052.scf.usercontent.goog/132c1d67-c528-48f3-b6a2-31b4e161b4b4" go-data-src="/gen?prompt=abstract+networking+connection+lines+background+dark+green+and+black+gradient+tech+style&amp;aspect=16:9" class="absolute inset-0 w-full h-full object-cover opacity-20 pointer-events-none" alt="Network Background" style="">
        
        <div class="container mx-auto px-6 relative z-10">
            <!-- Dialogue Simulation -->
            <div class="max-w-2xl mx-auto space-y-4 mb-16">
                <div class="chat-bubble chat-right fade-in">
                    <p class="font-bold flex items-center gap-2">
                        <span class="material-symbols-outlined">person</span>
                        شخص بصوت مستغرب:
                    </p>
                    <p class="text-lg">"ما ده موجود في أي تطبيق!"</p>
                </div>
                
                <div class="chat-bubble chat-left fade-in delay-100">
                    <p class="font-bold flex items-center gap-2 justify-end">
                        الرد:
                         <span class="material-symbols-outlined">smart_toy</span>
                    </p>
                    <p class="text-lg">"استنى بس... الميزة اللي محدش عامل زيها: <span class="text-emerald-500 font-bold text-xl">المجموعات بين الصحاب</span>."</p>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="order-2 md:order-1 relative">
                    <!-- Leaderboard Card -->
                    <div class="bg-white text-gray-800 rounded-2xl shadow-2xl p-6 transform rotate-1 hover:rotate-0 transition duration-500">
                        <div class="flex justify-between items-center mb-6 border-b pb-4">
                            <h3 class="font-bold text-xl">مجموعة "صحبة الجنة"</h3>
                            <span class="bg-emerald-100 text-emerald-800 px-3 py-1 rounded-full text-xs font-bold">نشطة الآن</span>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-3 bg-emerald-50 rounded-lg border border-emerald-100">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 bg-emerald-600 rounded-full flex items-center justify-center text-white font-bold">ع</div>
                                    <div>
                                        <p class="font-bold">علي محمد</p>
                                        <p class="text-xs text-gray-500">صلى الفجر في جماعة</p>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <p class="text-xs text-gray-500">مداومة</p>
                                    <p class="font-black text-orange-500 flex items-center gap-1">15 <span class="material-symbols-outlined text-sm">local_fire_department</span></p>
                                </div>
                            </div>

                            <!-- User 2 -->
                            <div class="flex items-center justify-between p-3 bg-white rounded-lg border hover:bg-gray-50 transition cursor-pointer">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold">أ</div>
                                    <div>
                                        <p class="font-bold">أحمد يوسف</p>
                                        <p class="text-xs text-gray-500">صلى العشاء</p>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <p class="text-xs text-gray-500">مداومة</p>
                                    <p class="font-black text-orange-500 flex items-center gap-1">8 <span class="material-symbols-outlined text-sm">local_fire_department</span></p>
                                </div>
                            </div>
                            
                            <!-- User 3 -->
                            <div class="flex items-center justify-between p-3 bg-white rounded-lg border hover:bg-gray-50 transition cursor-pointer opacity-75">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 bg-gray-400 rounded-full flex items-center justify-center text-white font-bold">س</div>
                                    <div>
                                        <p class="font-bold">سامي علي</p>
                                        <p class="text-xs text-red-500 font-bold">فاته الفجر!</p>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <p class="text-xs text-gray-500">مداومة</p>
                                    <p class="font-black text-gray-400 flex items-center gap-1">0 <span class="material-symbols-outlined text-sm">sentiment_very_dissatisfied</span></p>
                                </div>
                            </div>
                        </div>

                        <div class="mt-4 text-center">
                            <button class="text-emerald-600 text-sm font-bold hover:underline">أرسل تنبيه لسامي 🔔</button>
                        </div>
                    </div>
                </div>

                <div class="order-1 md:order-2">
                    <h2 class="text-3xl md:text-4xl font-bold mb-6 text-emerald-400">قوة المنافسة والمداومة 🔥</h2>
                    <p class="text-lg leading-relaxed mb-6 opacity-90">
                        "تقدر تعمل مجموعة مع أصحابك... وتشجعوا بعض على الصلاة في المسجد. وهنا بقى تظهر قيمة المداومة: <span class="text-yellow-400 font-bold">كل يوم بتصلّي فيه الخمس فروض كاملة... بيتحسبلك يوم مداومة.</span>"
                    </p>
                    <div class="bg-red-500/20 border border-red-500/50 p-4 rounded-xl mb-6">
                        <p class="text-red-300 font-bold flex items-center gap-2">
                            <span class="material-symbols-outlined">warning</span>
                            "لو يوم نقصت... المداومة بتبدأ من الأول!"
                        </p>
                    </div>
                    <p class="text-xl font-bold text-white">
                        "مين هيستمر أكتر؟ مين هيشدّ التاني؟ مين هيكون قدوة للمجموعة؟"
                    </p>
                </div>
            </div>
        </div>
    ...
    <!-- Final CTA -->
    <section class="py-20 bg-gradient-to-b from-emerald-600 to-teal-800 text-white text-center">
        <div class="container mx-auto px-6">
            <h2 class="text-4xl md:text-5xl font-black mb-6">مرآة المؤمن</h2>
            <p class="text-2xl mb-12 opacity-90 max-w-2xl mx-auto">"مش مجرد متابعة. ده صحبة، وتحفيز، والتزام... عشان نبقى أحسن كل يوم."</p>
            
            <div class="flex flex-col sm:flex-row justify-center gap-6 mb-12">
                <!-- <button class="bg-black text-white px-8 py-4 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-900 transition shadow-xl transform hover:-translate-y-1">
                    <span class="material-symbols-outlined text-3xl js-replaced-missing-icon">radio_button_unchecked</span>
                    <div class="text-right">
                        <p class="text-xs uppercase">Download on the</p>
                        <p class="font-bold text-xl">App Store</p>
                    </div>
                </button> -->
                <button onclick="window.location.href='../app.apk'" class="bg-white text-black px-8 py-4 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-100 transition shadow-xl transform hover:-translate-y-1">
                    <span class="material-symbols-outlined text-3xl text-green-600">android</span>
                    <div class="text-right">
                        <p class="text-xs uppercase">Get it on</p>
                        <p class="font-bold text-xl">Google Play</p>
                    </div>
                </button>
            </div>
            
            <p class="text-sm opacity-60">ابدأ رحلتك من النهارده.</p>
        </div>
    </section>

    <!-- Footer -->
    <footer class="bg-gray-900 text-gray-500 py-8 text-center border-t border-gray-800">
        <p>© 2025 تطبيق مرآة المؤمن. جميع الحقوق محفوظة.</p>
    </footer>
    ...
    <script>
        // Prayer Data & Logic
        const prayers = [
            { id: 'fajr', name: 'الفجر', status: 'none', sunnah: false },
            { id: 'dhuhr', name: 'الظهر', status: 'none', sunnah: false },
            { id: 'asr', name: 'العصر', status: 'none', sunnah: false },
            { id: 'maghrib', name: 'المغرب', status: 'none', sunnah: false },
            { id: 'isha', name: 'العشاء', status: 'none', sunnah: false },
        ];
        ...
        function renderPrayers() {
            ...
            prayers.forEach((prayer, index) => {
                ...
                if (prayer.status === 'done') {
                    statusClass = 'bg-emerald-100 text-emerald-600 border-emerald-500';
                    icon = 'check_circle';
                } else if (prayer.status === 'late') {
                    statusClass = 'bg-orange-100 text-orange-600 border-orange-500';
                    icon = 'history';
                } else if (prayer.status === 'missed') {
                    statusClass = 'bg-red-100 text-red-600 border-red-500';
                    icon = 'cancel';
                }

                const div = document.createElement('div');
                div.className = `mb-3 p-3 rounded-lg border-2 transition-all duration-300 ${prayer.status !== 'none' ? statusClass : 'bg-white border-gray-100 hover:border-gray-300'}`;
                
                div.innerHTML = `
                    <div class="flex justify-between items-center mb-2">
                        <span class="font-bold text-lg">${prayer.name}</span>
                        <span class="material-symbols-outlined cursor-pointer" onclick="toggleStatus(${index})">${icon}</span>
                    </div>
                    
                    <div class="flex gap-2 text-xs">
                        <button onclick="setStatus(${index}, 'done')" class="px-2 py-1 rounded ${prayer.status === 'done' ? 'bg-emerald-600 text-white' : 'bg-gray-200 hover:bg-emerald-200'}">صليت</button>
                        <button onclick="setStatus(${index}, 'late')" class="px-2 py-1 rounded ${prayer.status === 'late' ? 'bg-orange-500 text-white' : 'bg-gray-200 hover:bg-orange-200'}">قضاء</button>
                        <button onclick="setStatus(${index}, 'missed')" class="px-2 py-1 rounded ${prayer.status === 'missed' ? 'bg-red-500 text-white' : 'bg-gray-200 hover:bg-red-200'}">فاتتني</button>
                    </div>

                    <div class="mt-2 pt-2 border-t ${prayer.status !== 'none' ? 'border-gray-200/50' : 'border-gray-100'} flex items-center gap-2 cursor-pointer" onclick="toggleSunnah(${index})">
                        <span class="material-symbols-outlined text-sm ${prayer.sunnah ? 'text-yellow-500 filled' : 'text-gray-300'}">${prayer.sunnah ? 'star' : 'star_outline'}</span>
                        <span class="text-sm ${prayer.sunnah ? 'font-bold' : ''}">السنة / النافلة</span>
                    </div>
                `;
        ...
        function setStatus(index, status) {
            prayers[index].status = status;
            renderPrayers();
        }

        function toggleStatus(index) {
            // Cycle through statuses for the main icon click
            const current = prayers[index].status;
            if (current === 'none') prayers[index].status = 'done';
            else if (current === 'done') prayers[index].status = 'late';
            else if (current === 'late') prayers[index].status = 'missed';
            else prayers[index].status = 'none';
            renderPrayers();
        }

        function toggleSunnah(index) {
            prayers[index].sunnah = !prayers[index].sunnah;
            renderPrayers();
        }
        ...
        function addHabit() {
            ...
            if (value) {
                ...
                li.className = 'flex items-center justify-between bg-white p-3 rounded shadow-sm border-r-4 border-gray-200 animate-pulse';
                li.innerHTML = `
                    <span>${value}</span>
                    <span class="material-symbols-outlined text-gray-300 cursor-pointer hover:text-emerald-500" onclick="this.classList.toggle('text-emerald-500'); this.classList.toggle('text-gray-300'); this.innerText = this.classList.contains('text-emerald-500') ? 'check_circle' : 'radio_button_unchecked'">radio_button_unchecked</span>
                `;
    ...
    <!--
    "/gen?prompt=islamic+geometric+pattern+background+seamless+emerald+green+and+gold+minimalist&aspect=16:9"
    "/gen?prompt=flat+illustration+silhouette+of+a+person+sitting+on+prayer+mat+looking+at+phone+peacefully+at+sunset+with+mosque+dome+in+background,+minimalist+vector+art,+modern+style&aspect=1:1"
    "/gen?prompt=abstract+networking+connection+lines+background+dark+green+and+black+gradient+tech+style&aspect=16:9"
    -->
