...
<body class="text-gray-800">
    ...
    <nav class="fixed top-0 w-full bg-white/90 backdrop-blur-md shadow-sm z-50">
        <div class="container mx-auto px-6 py-3 flex justify-between items-center">
            ...
            <button class="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2 rounded-full font-bold transition shadow-lg">
                حمل التطبيق
            </button>
        </div>
    </nav>
        ...
        <div class="container mx-auto z-10 grid md:grid-cols-2 gap-12 items-center">
            <div class="text-center md:text-right fade-in">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    ...
                    <button class="bg-white text-emerald-600 border-2 border-emerald-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-emerald-50 transition flex items-center justify-center gap-2">
    ...
    <section class="py-20 bg-gradient-to-b from-emerald-600 to-teal-800 text-white text-center">
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-6 mb-12">
                ...
                <button class="bg-white text-black px-8 py-4 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-100 transition shadow-xl transform hover:-translate-y-1">
    ...
    <footer class="bg-gray-900 text-gray-500 py-8 text-center border-t border-gray-800">
        <p>© 2023 تطبيق مرآة المؤمن. جميع الحقوق محفوظة.</p>
    </footer>
